...
<div id="system">
	...
	<article class="item<?php if (!$params->get('show_create_date')) echo " no-date"; ?>"<?php if ($view != 'article') printf(' data-permalink="%s"', JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catslug), true, -1)); ?>>

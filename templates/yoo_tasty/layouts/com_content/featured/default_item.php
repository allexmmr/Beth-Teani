...
<article class="item<?php if (!$params->get('show_create_date')) echo " no-date"; ?>" data-permalink="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid), true, -1); ?>">
